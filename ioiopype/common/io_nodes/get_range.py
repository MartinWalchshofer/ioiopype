...
class GetRange(IONode):

    def __init__(self, rowStart, rowStop, columnStart, columnStop ):
        super().__init__()
        ...
        self.__rowStart = rowStart
        self.__rowStop = rowStop
        self.__columnStart = columnStart
        self.__columnStop = columnStop
    ...
    def update(self):
        ...
        if data is not None:
            ...
            self.write(0, data[self.__rowStart:self.__rowStop,self.__columnStart:self.__columnStop])